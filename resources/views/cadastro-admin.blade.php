...
<head>
    ...
    <meta name="description" content="Cadastro administrativo da plataforma GeoSync">
    <title>GeoSync | Cadastro de Administrador</title>
...
<div class="register-wrapper">
    ...
    <section class="brand-panel">
        <div class="brand-content">
            ...
            <p class="description">
                Configure uma nova conta para gerenciar usuários, monitorar relatórios e acessar a infraestrutura da GeoSync.
            </p>
            ...
            <div class="features">
                <div class="feature">
                    ...
                    <span>Controle de acessos e permissões</span>
                </div>
                ...
                <div class="feature">
                    ...
                    <span>Gerenciamento de frotas e serviços</span>
                </div>
                ...
                <div class="feature">
                    ...
                    <span>Ambiente protegido por chave de segurança</span>
                </div>
            </div>
        </div>
    ...
    <section class="form-panel">
        <div class="form-content">
            ...
            <div class="form-header">
                <div class="mini-title">Painel Administrativo</div>
                <h2>Criar Conta Admin</h2>
                <p>Preencha os dados e informe a chave de segurança autorizada.</p>
            </div>

            <form action="/cadastro-admin" method="POST" id="adminRegisterForm" class="form-grid">
                @csrf
                ...
                <div class="field full">
                    ...
                    <div class="input-wrap">
                        ...
                        <input
                            ...
                            name="email"
                            value="{{ old('email') }}"
                            placeholder="seu.admin@geosync.com"
                            autocomplete="email"
                            required
                        >
                    </div>
                ...
                <div class="field full">
                    <label for="security_token">Chave de segurança</label>
                    <div class="input-wrap">
                        ...
                        <input
                            ...
                            id="security_token"
                            name="security_token"
                            placeholder="Digite a chave de autorização"
                            required
                        >
                    </div>
                </div>
                ...
                <div class="register-box">
                    Já possui conta administrativa?
                    <a href="/login">Entrar no sistema</a>
                </div>

                <div class="security-note">
                    <i class="fas fa-shield-halved"></i>
                    <span>Ambiente restrito e protegido por autenticação.</span>
                </div>
